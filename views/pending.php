      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
			...
			$sql = "SELECT * FROM API_user_account join user on API_user_account.usr_id=user.email join wallet1 on API_user_account.usr_id=wallet1.userid WHERE usr_paytm_isVarified='1' OR usr_bank_isVarified='1' LIMIT 0,20";
				...
				while($rows = mysqli_fetch_array($result))
				{
					...
					<tr>
					 ...
					 <input type="hidden" name="email" value="<?php echo $rows['email1'];?>">
					  ...
					  <td><?php echo $rows['email1'];?></br><?php echo $rows['usr_id'];?></td>
